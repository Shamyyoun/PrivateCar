...
public class DialogUtils {
     ...
     * @param context
     */
    public static void showCallDialog(final Context context, final String phoneNumber) {
        String message = context.getString(R.string.call) + " " + phoneNumber + context.getString(R.string.question_mark);
        showConfirmDialog(context, message, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
